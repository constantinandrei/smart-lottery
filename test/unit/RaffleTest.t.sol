...
contract RaffleTest is Test {
    ...
    function testCantEnterRaffleWhenRaffleIsCalculating()
        public
    ...
    function testUpkeepShouldReturnFalseIfHasNoBalance() public {
        vm.warp(block.timestamp + interval + 1);
        vm.roll(block.number + 1);
    ...
    function testUpkeepShouldReturnFalseIfRaffleNotOpen()
        public
        raffleEnterAndTimePassed
    {
        raffle.performUpkeep("");
        ...
        skipFork
    {
        ...
        for (uint256 i = startingIndex; i <= addtionalEntrants; i++) {
